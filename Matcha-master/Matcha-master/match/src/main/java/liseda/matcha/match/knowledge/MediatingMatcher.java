...
import liseda.matcha.ontology.lexicon.LexiconExtender;
...
//Constructors
	 ...
	 */
	public MediatingMatcher(Lexicon x, String u)
	{
		ext = x;
		uri = u;
		description = DESCRIPTION;
...
//Public Methods
	...
	public void extendLexicons(Ontology o)
	{
		...
		Lexicon l = o.getLexicon(EntityType.CLASS);
...
//Protected Methods
	...
	protected Alignment hashMatch(Ontology o1, Ontology o2, EntityType e, double thresh)
	{
		...
		Lexicon source = o1.getLexicon(e);
		Lexicon target = o2.getLexicon(e);
	...
	protected Map2MapComparable<String,String,Double> match(Lexicon source, double thresh)
	{
		...
		{
			Set<String> sourceIndexes = source.getEntities(s);
