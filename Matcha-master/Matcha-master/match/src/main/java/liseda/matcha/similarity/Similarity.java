/*******************************************************************************
 * Utility class for computing similarity between strings and collections.     *
 *                                                                             *
 * @author Daniel Faria, Catia Pesquita                                        *
 ******************************************************************************/
package liseda.matcha.similarity;
...
public class Similarity
{
	 ...
	 * @param wn: the WordNet object (null if not to use WordNet)
	 * @return the similarity between the two names
	 */
	public static double nameSimilarity(String n1, String n2, WordNet wn)
	{
