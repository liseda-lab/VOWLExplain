...
public class DataMinCardinality extends ClassExpression implements CardinalityRestriction
{
...
//Constructor
	 ...
	 */
	public DataMinCardinality(DataPropertyExpression onProperty, Cardinality cardinality)
	{
		super();
	 ...
	 * @param cardinality: the restricted cardinality
	 */
	public DataMinCardinality(DataPropertyExpression onProperty, Cardinality cardinality, Datatype type)
	{
...
//Public Methods
	...
	{
		return o instanceof DataMinCardinality &&
				((DataMinCardinality)o).cardinality == this.cardinality &&
				((DataMinCardinality)o).onProperty.equals(this.onProperty) &&
				(
					(((DataMinCardinality)o).type == null && this.type == null) ||
					((DataMinCardinality)o).type.equals(this.type)
				);
	}
